    ...
    public form() {
        ...
        for(int i = 0; i < points_size; i++)
        {
            for(int j = 0; j < points_size; j++)
            {
                ...
                //cells[i][j] = new Point(i, j, Life.Dead);
            }
        }
        
        //provo aliante (nel ciclo prima si fanno tutte dead)
        /*
        cells[4][4] = new Point(4, 4, Life.Live);
        cells[4][5] = new Point(4, 5, Life.Live);
        cells[4][6] = new Point(4, 6, Life.Live);
        cells[5][4] = new Point(5, 4, Life.Live);
        cells[6][5] = new Point(6, 5, Life.Live);
        */
        //assegno la matrice di textbox, è la porzione di Point vista nella form
        ...
        //aggiorna stato textbox:
        for(int i = 0; i < matrix_size; i++)
        {
            for(int j = 0; j < matrix_size; j++)
            {
                if(cells[i][j].getOldLife() == Life.Live)
                {
        ...
        system = ActorSystem.create("GameOfLifeSystem");
        controller = system.actorOf(Props.create(ActorController.class), "GameOfLifeController");
        controller.tell(new MsgLoad(flag, new Griglia(matrix, cells, points_size, points_size, matrix_size, matrix_size, jLabel1)), ActorRef.noSender());
        controller.tell(new MsgStart(), controller);
    }
