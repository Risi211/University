...
/*
static long Get_LastDate(String cluster_name) throws RepositoryException
{

    //LEGGE DA CONFIG.INSTANCE il numero di porta, username e password
    
            String url = "http://localhost:11008/jackrabbit/server/";
